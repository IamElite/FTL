...
from src.utils.bot_utils import (gen_dc_txt, get_user, log_newusr,
                                     reply_user_err)
from src.utils.database import db
from src.utils.decorators import check_banned
from src.utils.file_properties import get_fname, get_fsize, parse_fid
from src.utils.force_channel import force_channel_check, get_force_info
...
from src.utils.messages import (
    ...
    MSG_BUTTON_UPDATES, MSG_BUTTON_JOIN_CHANNEL, MSG_BUTTON_VIEW_PROFILE,
...
async def start_command(bot: Client, msg: Message):
    ...
    btns = [
        ...
        [InlineKeyboardButton(MSG_BUTTON_UPDATES, url="https://t.me/SyntaxRealm"),
