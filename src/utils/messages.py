...
MSG_WELCOME = (
    "🌟 **Welcome, {user_name}!** 🌟\n\n"
    "I'm **SyntaxRealm - File to Link Bot** ⚡\n"
...
MSG_HELP = (
    ...
    "❓ Questions? Please ask in our [support group](https://t.me/SyntaxRealm)!"
)

MSG_ABOUT = (
    "🌟 **About SyntaxRealm - File to Link Bot** ℹ️\n\n"
    ...
    "💖 If you find me useful, please consider [sharing me](https://t.me/share/url?url=https://t.me/SyntaxRealm) with your friends!"
)
