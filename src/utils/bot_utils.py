...
from src.utils.file_properties import get_fname, get_fsize, get_hash
...
async def gen_links(fwd_msg: Message, request: Any, shortener: bool = True) -> Dict[str, str]:
